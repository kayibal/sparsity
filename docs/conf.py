...
version = sparsity.__version__.split('-')[0]
# The full version, including alpha/beta/rc tags.
release = sparsity.__version__
...
latex_documents = [
    ('index',
     'Sparsity.tex',
     u'Sparsity Documentation',
     u"Datarevenue", 'manual'),
]
